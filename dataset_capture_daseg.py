...
def main(config):
    ...
    try:
       ...
       #### RGB Cameras ####
        ...
        ##############################################################################################
        with CarlaSyncMode(world, camera_rgb_1,camera_rgb_2,camera_rgb_3,camera_rgb_4,camera_rgb_5,ss_camera_1,ss_camera_2,ss_camera_3,ss_camera_4,ss_camera_5, fps=10) as sync_mode:
            counter = 0
            while True:
                if should_quit():
                    return
                clock.tick()
                save = np.random.randint(1,100)
                
                
                # Advance the simulation and wait for the data.
                snapshot, rgb_1,rgb_2,rgb_3,rgb_4,rgb_5,ss_1,ss_2,ss_3,ss_4,ss_5 = sync_mode.tick(timeout=10.0) #Ajusta timeout si el pc es muy lento
                ...
                if( save == 1):
                    ...
                    ss_1.save_to_disk(dataset_path+('cam1/ss/{}.png').format(ss_1.frame)) # Save the scan
